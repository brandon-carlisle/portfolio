...
3. Add any secrets or env vars in the Cloudflare project (Dashboard → Settings → Variables). For local dev, use `.dev.vars` in the project root (gitignored); never commit secrets.
